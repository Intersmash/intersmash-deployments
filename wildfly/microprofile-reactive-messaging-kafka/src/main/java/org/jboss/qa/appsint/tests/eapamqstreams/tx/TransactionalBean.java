...
package org.jboss.qa.appsint.tests.eapamqstreams.tx;
...
/**
 * Taken from WildFly testsuite, see org.wildfly.test.integration.microprofile.reactive.messaging.kafka.tx.TransactionalBean.
 */
@ApplicationScoped
